...
# MOVED FROM THE RESIDENT COPY ON 2026-08-27 (crew#26 CP-B)

Everything below this line was cut from `~/AGENTS.md` unchanged so the resident injection fits 12 KB. It binds exactly as it did there.

# The laws (history paragraphs of the resident copy)
...
# THE FOUR HARD RULES (preamble of the resident copy)
...
# How to work (subsections of the resident copy)
...
# Effective order (moved verbatim from the resident copy, 2026-08-31)

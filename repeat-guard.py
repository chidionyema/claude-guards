...
def reflection(first: str, again: str) -> str:
    return (
        ...
        "     yours (LAW 4). Make the change, then say what you changed.\n"
        "  2. TICKET IT with a number. A GitHub issue or a row in the register, linked, so the next\n"
        "     session starts from your standing point instead of the beginning (the handoff file).\n"
        ...
        "     only the founder can make. If you cannot name it, you are not blocked (LAW 4).\n\n"

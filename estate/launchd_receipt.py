...
# crew#13: ~/.hermes is retired. The receipt file lives under ~/.estate; readers
# (prospector scripts/process_audit.py, scripts/engine_failover.py) use the same path.
RECEIPTS = Path(os.environ.get("CAPABILITY_RECEIPTS") or os.path.expanduser("~/.estate/state/capability_receipts.jsonl"))

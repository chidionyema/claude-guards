...
def test_incident_crew306_auto_objective():
    _selftest("auto-objective.py")
...
if __name__ == "__main__":
    for f in (test_incident_crew306_auto_objective, test_incident_crew306_session_timeout, test_incident_crew306_board):
